...
const Hero = () => {
  const fullText = "Criando experiências digitais inovadoras";
    ...
    <HeroSection id="home">
      <HeroContent>
        ...
        >
          ...
          >
            Unindo código e criatividade para construir experiências digitais
            funcionais, acessíveis e bem estruturadas.
          </Description>
          ...
          >
            ...
            <a
              href="https://www.behance.net/gallery/219285967/BrandBook-Vox-Midia"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaBehance />
